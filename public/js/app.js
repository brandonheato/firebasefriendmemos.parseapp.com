...
function LoginCtrl($scope, $rootScope, $location, user) {
  if (user){
...
app.factory('userProvider', function($q, $rootScope, $location) {
  var userDefer = $q.defer();
  var cachedUserPromise = userDefer.promise;
  var cachedUser = null;
...
app.factory("fbFriendsProvider", function($q, userProvider, $rootScope, $location, $http) {
